 ...
 * @author mario
 */
public class Listado_pieza extends javax.swing.JPanel {

    String buscador = "";
    /**
     * Creates new form Ver_cliente
     */
    public Listado_pieza() {
        initComponents();
        Main.mostrarListadoPiezas(t_buscador.getText(),tabla,buscador);
    ...
    private void t_buscadorKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_t_buscadorKeyReleased
        ...
        Main.mostrarListadoPiezas(filtro,tabla,buscador);
