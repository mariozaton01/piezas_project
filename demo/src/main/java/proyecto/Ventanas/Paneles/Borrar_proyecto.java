 ...
 * @author mario
 */
public class Borrar_proyecto extends javax.swing.JPanel {
    ...
    public Borrar_proyecto() {
        initComponents();
        Main.getProyectotoComboBox(cb_proyectos);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Borrar proyecto");

        jLabel2.setText("Selecciona el proyecto a borrar:");
                        ...
                        .addGroup(layout.createSequentialGroup()
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                    ...
                                    .addGap(47, 47, 47))
                                .addComponent(cb_proyectos, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 211, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGap(406, 406, 406)))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
    ...
    private void b_borrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_borrarActionPerformed
        ...
        String selectedValue = cb_proyectos.getSelectedItem().toString();
        String id = selectedValue.split("-")[0];

        Main.deleteProyecto(id);
        cb_proyectos.removeAllItems();
        Main.getProyectotoComboBox(cb_proyectos);
